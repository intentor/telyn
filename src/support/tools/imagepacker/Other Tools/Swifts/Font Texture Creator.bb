...
Global CHARACTER_SET$ = "!" + Chr$(34) + "#$%&'()*+,-./0123456789:;<=>?@"
CHARACTER_SET$=CHARACTER_SET$+"ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`"
CHARACTER_SET$=CHARACTER_SET$+"abcdefghijklmnopqrstuvwxyz{|}~''¡¢£"
Global TEXTURE_RESOLUTION = 256; Must be a power of 2.  (256 reccomended)
Global CHARACTER_RESOLUTION = 16; Must be a power of 2 <= TEXTURE_RESOLUTION.

Global FONT_NAME$ = "Arial Black"
Global FONT_HEIGHT = 14; Should be less than CHARACTER_RESOLUTION to avoid errors in the image.
